...
export function DatabaseNotice() {
  ...
  return (
    ...
    >
      <p className="font-display tracking-wide uppercase">Waiting for another tab</p>
      <p className="mt-1 text-ink-dim">
        Cinetier is open in another tab on an older version, which is holding the database open.
        Nothing has been lost. Close or reload that tab and this one carries on by itself.
      </p>
    </div>
  );
}
